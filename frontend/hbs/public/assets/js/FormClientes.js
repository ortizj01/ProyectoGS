...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function validateForm() {
        ...
        const documentoInput = document.querySelector('input[name="DocumentoCliente"]');
        const correoInput = document.querySelector('input[name="correoCliente"]');
        const direccionInput = document.querySelector('input[name="direccionCliente"]');
        const contactoInput = document.querySelector('input[name="contactoCliente"]');
        ...
        updateErrorMessage('DocumentoCliente-error', isValidDocumento, 'Ingrese un número de documento válido (10 dígitos)');
